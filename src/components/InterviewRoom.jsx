 ...
 * Google Meet-style UI for the voice interview
 */
...
export function InterviewRoom({
  ...
  // Show results screen when call ended and we have results
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4">
        <div className="w-full max-w-lg bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
          <div className="text-center mb-8">
            ...
            <p className="text-purple-300">Thank you for participating, {candidateName}</p>
          </div>
          ...
          {/* Summary */}
          <div className="bg-white/5 rounded-xl p-6 mb-6">
            <h3 className="text-sm font-medium text-purple-300 mb-2">Feedback</h3>
          ...
          <button
            onClick={onLeave}
            className="w-full py-4 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold rounded-lg transition"
          >
            Start New Interview
          </button>
        </div>
  ...
  // Show ended screen without results
  if (isEnded) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-white mb-4">Interview Ended</h2>
          <p className="text-gray-400 mb-6">The call has been disconnected.</p>
          <button
            onClick={onLeave}
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex flex-col">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-white/10">
        <div className="flex items-center gap-3">
          <div className="text-white font-semibold">Wimaan AI Interview</div>
          {isConnected && (
        ...
        <div className="text-white font-mono text-lg">{formattedDuration}</div>
      </div>
      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-6 p-6">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="relative">
            {/* Avatar Container */}
            <div
              className={`w-64 h-64 rounded-full bg-gradient-to-br from-purple-600 to-pink-600 flex items-center justify-center shadow-2xl ${
            ...
            {/* Speaking Indicator */}
            {isSpeaking && (
              <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 bg-purple-500 px-4 py-1 rounded-full">
      ...
      <div className="border-t border-white/10 px-6 py-4">
        <div className="flex items-center justify-center gap-4">
          ...
          <button
            onClick={onEndCall}
            disabled={!isConnected}
            className="w-14 h-14 rounded-full bg-red-600 hover:bg-red-700 flex items-center justify-center transition disabled:opacity-50 disabled:cursor-not-allowed"
            title="End Call"
          >
            <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
        ...
        <p className="text-center text-gray-400 text-sm mt-4">
          Interviewing: <span className="text-white">{candidateName}</span>
        </p>
      </div>
    </div>
  );
